...
/**
 * Lets the user opt into downloading the offline captioning model (~250MB,
  ...
  return (
    <section className="rounded-md border border-neutral-200 p-3 text-sm">
      ...
      <p className="mt-1 text-xs text-neutral-500">
        A separate on-device captioning model (~250MB, one-time download, then works with zero internet). Less
